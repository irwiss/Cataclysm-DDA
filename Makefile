...
JSON_FORMATTER_SOURCES := $(wildcard tools/format/*.cpp) src/cached_options.cpp src/json.cpp
JSON_FORMATTER_HEADERS := $(wildcard tools/format/*.h)
CHKJSON_SOURCES := $(wildcard src/chkjson/*.cpp) src/cached_options.cpp src/json.cpp
