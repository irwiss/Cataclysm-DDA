...
// we'll store requirement_ids here and wait for requirements to load in
// then we can actualize them in finalize and clear this map
...
{
    requirements = make_shared_fast<requirement_data>();
