...
void try_parse_int_simple_parsing( const std::string &type_name )
{
    CAPTURE( type_name );
...
{
    try_parse_int_simple_parsing<int>( "int" );
    try_parse_int_simple_parsing<long>( "long" );
    try_parse_int_simple_parsing<long long>( "long long" );
}

template<typename TestType>
void try_parse_int_locale_parsing( const std::string &type_name )
{
    CAPTURE( type_name );
    std::locale const &oldloc = std::locale();
    on_out_of_scope reset_loc( [&oldloc]() {
...
{
    try_parse_int_locale_parsing<int>( "int" );
    try_parse_int_locale_parsing<long>( "long" );
    try_parse_int_locale_parsing<long long>( "long long" );
}
